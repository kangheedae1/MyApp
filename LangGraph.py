...
def routing_intent(state : State) -> str:
   #Classify_intent된 의도(intent)를 가져옴
...
# generate_search keyword : 음식/활동별로 검색해 볼만한 키워드를 생성
